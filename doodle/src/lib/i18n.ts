...
import { SCENE_SUGGESTIONS_BY_LOCALE } from "./scenes/localized-suggestions";
...
export interface DoodleCopy {
  ...
  footer: { privacy: string; terms: string; refunds: string; contact: string; social: string; followX: string };
  composer: {
    title: string;
    hint: string;
    label: string;
  ...
  actions: { download: string; tryAgain: string; redraw: string; newScene: string; makeCard: string };
  card: CardCopy;
  dialog: {
    label: string;
    close: string;
...
const COPY = {
  en: {
    ...
    footer: { privacy: "Privacy", terms: "Terms", refunds: "Refunds", contact: "Contact", social: "Social", followX: "Follow Sami on X" },
    composer: {
    ...
    suggestions: {
      title: "Or try one",
      items: SCENE_SUGGESTIONS_BY_LOCALE.en,
    },
    stage: {
    ...
    actions: { download: "Download", tryAgain: "Try again", redraw: "Redraw this idea", newScene: "Draw something else", makeCard: "Make a card" },
    card: { title: "Add a little message", messageLabel: "Your message (optional)", messagePlaceholder: "Thank you!", messageHint: "Up to 80 characters", previewAlt: "Card preview", preparing: "Preparing your card", download: "Download card", share: "Share card", shareFallback: "Sharing is unavailable here. Download the card instead.", close: "Close card", error: "This card could not be prepared. Try again." },
    dialog: {
  ...
  nl: {
    ...
    footer: { privacy: "Privacy", terms: "Voorwaarden", refunds: "Terugbetalingen", contact: "Contact", social: "Sociale media", followX: "Volg Sami op X" },
    composer: {
    ...
    suggestions: {
      ...
      items: SCENE_SUGGESTIONS_BY_LOCALE.nl,
    },
    stage: {
    ...
    actions: { download: "Downloaden", tryAgain: "Opnieuw", redraw: "Teken dit idee opnieuw", newScene: "Teken iets anders", makeCard: "Een kaart maken" },
    card: { title: "Voeg een klein bericht toe", messageLabel: "Je bericht (optioneel)", messagePlaceholder: "Bedankt!", messageHint: "Maximaal 80 tekens", previewAlt: "Voorbeeld van de kaart", preparing: "Je kaart wordt voorbereid", download: "Kaart downloaden", share: "Kaart delen", shareFallback: "Delen is hier niet beschikbaar. Download de kaart.", close: "Kaart sluiten", error: "De kaart kon niet worden voorbereid. Probeer het opnieuw." },
  ...
  de: {
    ...
    footer: { privacy: "Datenschutz", terms: "Bedingungen", refunds: "Rückerstattungen", contact: "Kontakt", social: "Soziale Medien", followX: "Sami auf X folgen" },
    ...
    suggestions: { title: "Oder probiere das", items: SCENE_SUGGESTIONS_BY_LOCALE.de },
    ...
    actions: { download: "Herunterladen", tryAgain: "Noch einmal", redraw: "Diese Idee neu zeichnen", newScene: "Etwas anderes zeichnen", makeCard: "Karte erstellen" },
    card: { title: "Füge eine kleine Nachricht hinzu", messageLabel: "Deine Nachricht (optional)", messagePlaceholder: "Danke!", messageHint: "Bis zu 80 Zeichen", previewAlt: "Kartenvorschau", preparing: "Deine Karte wird vorbereitet", download: "Karte herunterladen", share: "Karte teilen", shareFallback: "Teilen ist hier nicht verfügbar. Lade die Karte herunter.", close: "Karte schließen", error: "Die Karte konnte nicht vorbereitet werden. Versuch es noch einmal." },
    ...
    purchase: { label: "Doodles auffüllen", title: "Weiterzeichnen", quantity: "10 weitere Doodles", price: "€4.99", reassurance: "Einmal zahlen. Kein Abo.", failedDontCount: "Fehlgeschlagene Bilder werden nicht abgezogen.", buy: "10 Doodles kaufen", cancel: "Nicht jetzt", restore: "Schon gekauft? Anmelden", added: "10 Doodles hinzugefügt", startDrawing: "Jetzt zeichnen", checkoutError: "Die Zahlung konnte nicht gestartet werden. Versuch es noch einmal.", applePay: "Mit Apple Pay bezahlen" },
    auth: { signIn: "Anmelden", google: "Mit Google fortfahren", loading: "Anmeldung wird geladen…", authError: "Die Anmeldung konnte nicht abgeschlossen werden. Versuch es noch einmal." },
  ...
  fr: {
    ...
    footer: { privacy: "Confidentialité", terms: "Conditions", refunds: "Remboursements", contact: "Contact", social: "Réseaux sociaux", followX: "Suivre Sami sur X" },
    ...
    suggestions: { title: "Ou essayez ceci", items: SCENE_SUGGESTIONS_BY_LOCALE.fr },
    ...
    actions: { download: "Télécharger", tryAgain: "Réessayer", redraw: "Redessiner cette idée", newScene: "Dessiner autre chose", makeCard: "Créer une carte" },
    card: { title: "Ajoutez un petit message", messageLabel: "Votre message (facultatif)", messagePlaceholder: "Merci !", messageHint: "80 caractères maximum", previewAlt: "Aperçu de la carte", preparing: "Préparation de votre carte", download: "Télécharger la carte", share: "Partager la carte", shareFallback: "Le partage n’est pas disponible ici. Téléchargez la carte.", close: "Fermer la carte", error: "La carte n’a pas pu être préparée. Réessayez." },
  ...
  es: {
    ...
    footer: { privacy: "Privacidad", terms: "Condiciones", refunds: "Reembolsos", contact: "Contacto", social: "Redes sociales", followX: "Seguir a Sami en X" },
    ...
    suggestions: { title: "O prueba una idea", items: SCENE_SUGGESTIONS_BY_LOCALE.es },
    ...
    actions: { download: "Descargar", tryAgain: "Intentar de nuevo", redraw: "Volver a dibujar esta idea", newScene: "Dibujar otra cosa", makeCard: "Crear una tarjeta" },
    card: { title: "Añade un pequeño mensaje", messageLabel: "Tu mensaje (opcional)", messagePlaceholder: "¡Gracias!", messageHint: "Hasta 80 caracteres", previewAlt: "Vista previa de la tarjeta", preparing: "Preparando tu tarjeta", download: "Descargar tarjeta", share: "Compartir tarjeta", shareFallback: "Compartir no está disponible aquí. Descarga la tarjeta.", close: "Cerrar tarjeta", error: "No se pudo preparar la tarjeta. Inténtalo de nuevo." },
    ...
    auth: { signIn: "Iniciar sesión", google: "Continuar con Google", loading: "Cargando el inicio de sesión…", authError: "No se pudo completar el inicio de sesión. Inténtalo de nuevo." },
  ...
  "pt-br": {
    ...
    footer: { privacy: "Privacidade", terms: "Termos", refunds: "Reembolsos", contact: "Contato", social: "Redes sociais", followX: "Seguir Sami no X" },
    ...
    suggestions: { title: "Ou experimente uma ideia", items: SCENE_SUGGESTIONS_BY_LOCALE["pt-br"] },
    ...
    actions: { download: "Baixar", tryAgain: "Tentar novamente", redraw: "Desenhar esta ideia de novo", newScene: "Desenhar outra coisa", makeCard: "Criar um cartão" },
    card: { title: "Adicione uma mensagem curta", messageLabel: "Sua mensagem (opcional)", messagePlaceholder: "Obrigado!", messageHint: "Até 80 caracteres", previewAlt: "Prévia do cartão", preparing: "Preparando seu cartão", download: "Baixar cartão", share: "Compartilhar cartão", shareFallback: "O compartilhamento não está disponível aqui. Baixe o cartão.", close: "Fechar cartão", error: "Não foi possível preparar o cartão. Tente novamente." },
  ...
  it: {
    ...
    footer: { privacy: "Privacy", terms: "Termini", refunds: "Rimborsi", contact: "Contatti", social: "Social", followX: "Segui Sami su X" },
    ...
    suggestions: { title: "Oppure prova un’idea", items: SCENE_SUGGESTIONS_BY_LOCALE.it },
    ...
    actions: { download: "Scarica", tryAgain: "Riprova", redraw: "Ridisegna questa idea", newScene: "Disegna qualcos’altro", makeCard: "Crea una cartolina" },
    card: { title: "Aggiungi un piccolo messaggio", messageLabel: "Il tuo messaggio (facoltativo)", messagePlaceholder: "Grazie!", messageHint: "Fino a 80 caratteri", previewAlt: "Anteprima della cartolina", preparing: "Preparazione della cartolina", download: "Scarica cartolina", share: "Condividi cartolina", shareFallback: "La condivisione non è disponibile qui. Scarica la cartolina.", close: "Chiudi cartolina", error: "Non è stato possibile preparare la cartolina. Riprova." },
    ...
    purchase: { label: "Ricarica disegni", title: "Continua a disegnare", quantity: "Altri 10 disegni", price: "€4.99", reassurance: "Un solo pagamento. Nessun abbonamento.", failedDontCount: "I tentativi non riusciti non vengono scalati.", buy: "Ottieni 10 disegni", cancel: "Non ora", restore: "Hai già acquistato? Accedi", added: "Aggiunti 10 disegni", startDrawing: "Inizia a disegnare", checkoutError: "Non è stato possibile aprire il pagamento. Riprova.", applePay: "Paga con Apple Pay" },
    auth: { signIn: "Accedi", google: "Continua con Google", loading: "Caricamento dell’accesso…", authError: "Non è stato possibile completare l’accesso. Riprova." },
  ...
  ja: {
    ...
    footer: { privacy: "プライバシー", terms: "利用規約", refunds: "返金", contact: "お問い合わせ", social: "ソーシャル", followX: "XでSamiをフォロー" },
    ...
    suggestions: { title: "こんな場面もおすすめ", items: SCENE_SUGGESTIONS_BY_LOCALE.ja },
    ...
    actions: { download: "ダウンロード", tryAgain: "もう一度", redraw: "同じアイデアで描き直す", newScene: "別のものを描く", makeCard: "カードを作る" },
    card: { title: "ひとことを添える", messageLabel: "メッセージ（任意）", messagePlaceholder: "ありがとう！", messageHint: "80文字まで", previewAlt: "カードのプレビュー", preparing: "カードを準備しています", download: "カードをダウンロード", share: "カードを共有", shareFallback: "この環境では共有できません。カードをダウンロードしてください。", close: "カードを閉じる", error: "カードを準備できませんでした。もう一度お試しください。" },
    ...
    purchase: { label: "イラストの追加", title: "もっと描こう", quantity: "あと10枚のイラスト", price: "€4.99", reassurance: "お支払いは1回だけ。定期購入ではありません。", failedDontCount: "作成に失敗した分は減りません。", buy: "10枚追加する", cancel: "今はしない", restore: "購入済みですか？ログイン", added: "10枚追加しました", startDrawing: "描き始める", checkoutError: "お支払い画面を開けませんでした。もう一度お試しください。", applePay: "Apple Payで支払う" },
    auth: { signIn: "ログイン", google: "Googleで続ける", loading: "ログインを読み込んでいます…", authError: "ログインを完了できませんでした。もう一度お試しください。" },
  ...
  ko: {
    ...
    footer: { privacy: "개인정보처리방침", terms: "이용약관", refunds: "환불", contact: "문의", social: "소셜", followX: "X에서 Sami 팔로우" },
    ...
    suggestions: { title: "이런 장면도 좋아요", items: SCENE_SUGGESTIONS_BY_LOCALE.ko },
    ...
    actions: { download: "다운로드", tryAgain: "다시 만들기", redraw: "같은 아이디어로 다시 그리기", newScene: "다른 그림 그리기", makeCard: "카드 만들기" },
    card: { title: "짧은 메시지를 더해 보세요", messageLabel: "메시지 (선택 사항)", messagePlaceholder: "고마워요!", messageHint: "80자까지", previewAlt: "카드 미리보기", preparing: "카드를 준비하는 중", download: "카드 다운로드", share: "카드 공유", shareFallback: "이 환경에서는 공유할 수 없습니다. 카드를 다운로드하세요.", close: "카드 닫기", error: "카드를 준비하지 못했습니다. 다시 시도해 주세요." },
    ...
    purchase: { label: "그림 채우기", title: "계속 그려 보세요", quantity: "그림 10장 더", price: "€4.99", reassurance: "한 번만 결제해요. 구독이 아니에요.", failedDontCount: "만들기에 실패한 그림은 차감되지 않아요.", buy: "그림 10장 받기", cancel: "나중에", restore: "이미 구매했나요? 로그인", added: "그림 10장을 추가했어요", startDrawing: "그리기 시작", checkoutError: "결제 화면을 열 수 없어요. 다시 시도해 주세요.", applePay: "Apple Pay로 결제" },
    auth: { signIn: "로그인", google: "Google로 계속", loading: "로그인을 불러오는 중…", authError: "로그인을 완료하지 못했어요. 다시 시도해 주세요." },
  ...
  ar: {
    ...
    footer: { privacy: "الخصوصية", terms: "الشروط", refunds: "استرداد الأموال", contact: "تواصل معنا", social: "التواصل الاجتماعي", followX: "تابع سامي على إكس" },
    ...
    suggestions: { title: "أو جرّب فكرة", items: SCENE_SUGGESTIONS_BY_LOCALE.ar },
    ...
    actions: { download: "تنزيل", tryAgain: "جرّب مرة أخرى", redraw: "أعد رسم هذه الفكرة", newScene: "ارسم شيئًا آخر", makeCard: "أنشئ بطاقة" },
    card: { title: "أضف رسالة صغيرة", messageLabel: "رسالتك (اختياري)", messagePlaceholder: "شكرًا!", messageHint: "حتى 80 حرفًا", previewAlt: "معاينة البطاقة", preparing: "جارٍ تجهيز بطاقتك", download: "تنزيل البطاقة", share: "مشاركة البطاقة", shareFallback: "المشاركة غير متاحة هنا. نزّل البطاقة بدلًا من ذلك.", close: "إغلاق البطاقة", error: "تعذّر تجهيز البطاقة. حاول مرة أخرى." },
