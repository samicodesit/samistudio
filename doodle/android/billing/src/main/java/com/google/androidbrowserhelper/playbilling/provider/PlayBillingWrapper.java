...
public class PlayBillingWrapper implements BillingWrapper {
    ...
    public boolean launchPaymentFlow(Activity activity, ProductDetails productDetails, MethodData methodData) {
        BillingResult result = mClient.launchBillingFlow(
                activity, createBillingFlowParams(productDetails, methodData));
    ...
    static BillingFlowParams createBillingFlowParams(
            ProductDetails productDetails, MethodData methodData) {
        ...
        BillingFlowParams.Builder builder = BillingFlowParams.newBuilder()
            ...
            .setObfuscatedAccountId(methodData.obfuscatedAccountId);
