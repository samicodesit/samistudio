...
public class MethodData {
    ...
    private MethodData(String sku, String obfuscatedAccountId,
                       boolean isPriceChangeConfirmation, @Nullable String oldSku,
    ...
    private static MethodData fromJsonInner(String json) throws JSONException {
        ...
        return new MethodData(sku, obfuscatedAccountId, isPriceChangeConfirmation,
                oldSku, purchaseToken, replacementMode);
    }
