...
await fs.writeFile(path.join(output, 'manifest.json'), JSON.stringify({ capturedAt: new Date().toISOString(), origin: base, provenance: 'Chromium mobile browser rendering of local app. Account and generation API responses intercepted. No Android OS frame or Play installation. Drawings are existing repository examples, not new generations. Final Android verification still required.', size: '1080x1920', captures }, null, 2));
